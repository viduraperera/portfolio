  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(115,129,129,1) 25%, rgba(118,130,133,1) 100%)",
      }}
    >
      <div className={`${id === 6} && 'flex justify-center h-full`}>
        ...
        >
          <div className="font-sans font-extralight tex-[#c1c2d3] text-sm md:text-xs lg:text-base z-10">
            {description}
          </div>
